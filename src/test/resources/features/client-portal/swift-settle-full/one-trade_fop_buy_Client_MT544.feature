...
Feature: Client portal
  ...
  Scenario Outline: CSV - Validate Swift settle of FOP BUY trough v1...v4 in Trades, Ledger Postings and Securities Positions screens via Client profile
    ...
    Then "TRADE" CSV is uploaded successfully
      ...
      | TRADE     | UK                    | NEW          | ACLRAU2S              | VenueID01 | Testexid01 | ACLRAU2S            | 5.26             | CPTYName01            | CPTYLocal02                   | CPTYLocalCustAccNumber02                | 123                       | CPTY             | CPTY1234568      | InterBank02      | Place02                | REG02        | csv upload client portal | Stamp02         | 1                   | TRUE             | 10                     | Intermediaries | FALSE                      | <legalEntityCode> | <clientCode> | <clientMasterAccountName> | <brokerCode> | @date(<tradeDate>) | <isin> | <securityType> | <securityDescription> | <subAccount>     | <direction> | <tradeQuantity> | <settMethod>      | @date(<settDate>) | <settCountry>     | @default() | @default()        |
  ...
  """
    ...
    Examples:
      ...
      | client-defaultEnv | JohnDoeCPSwiftSettleClient | custx11*   | JohnDoeCPSwiftSettleClient2 | custx11*    | admin-defaultEnv | JohnDoe  | Password11* | T-2       | T        | FOP        | Client Securities Fop | CP:csv:SFL-GBP-BEL:FOP:T-2:BUY:EQ | GBP     | BUY       | SFL             | Auto_Swift_Full_Settle | Auto_Swift_Settle_Full  | SFL        | NL0000235190 | EQUITY       | AIRBUS              | EUR         | USA         | BNY       | BNYDepotCode | 1000          | 1,000 | 0.7713    | 1.9200     | 771.30    | 1,480.90             | Custody Client Securities Account | Market Securities 'In Transit' Account | Market Securities 'In Transit' Account | Depot Account   |

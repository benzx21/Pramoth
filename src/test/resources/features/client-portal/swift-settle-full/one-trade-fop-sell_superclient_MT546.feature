...
Feature: Client portal
  ...
  Scenario Outline: Swift Settle SELL MT546 Modal - Single trade FOP v1...v4 in Trades, Ledger Postings and Securities Positions screens (Super Client)
    ...
    And validate snapshot "c-security_position_v1" on
      | COB Date          | CustX Account Name        | Client Code  | Master Account            | ISIN   | Security              | Asset Type     | Unsettled Trades? | Traded Quantity | Contractual Sett Qty | Actual Sett Qty | Indicative Ccy | Base Ccy  | Indicative COB Price | Fx Rate (Indicative ccy to Base ccy) | Current MTM Value (Underlying Ccy) | Current MTM Value (Base Ccy) |
      | @date(<settDate>) | <clientCode>-<subAccount> | <clientCode> | <clientMasterAccountName> | <isin> | <securityDescription> | <securityType> | YES               | <qty>           | <qty>                | 0               | <securityCcy>  | <baseCcy> | <secPriceT>          | <secFxRateT>                         | <qty*price>                        | <qty*price*secFxRateT>       |
    ...
    When swift inbound
    """
    {1:F01PARBFRPPDXXX0001000000}{2:I546IGLUGB2LXXXXN}{3:{108:ISI419041C8Z8000}}{4:
    :16R:GENL
    :20C::SEME//@context(LAST_CUSTODIAN_TRADE_REF)
    :23G:NEWM
    :98C::PREP//20220210160435
    :16R:LINK
    :13A::LINK//542
    ...
    Examples:
      ...
      | client-defaultEnv | JohnDoeCPSwiftSettle | custx11*   | admin-defaultEnv | JohnDoe  | Password11* | T-2       | T        | FOP        | Client Securities Fop | CP:mod:SFL-GBP-BEL:FOP:T-2:SELL:FI | GBP     | SELL      | Auto_Swift_Full_Settle | Auto_Swift_Settle_Full  | BE0000352618 | FIXED_INCOME | BEGV 10/22/31       | EUR         | GBR         | BNY       | BNYDepotCode | 1000          | -1,000 | 173.0000  | 1.9200     | -173,000.00 | -332,160.00          | Market Securities 'In Transit' Account | Custody Client Securities Account | Depot Account   | Market Securities 'In Transit' Account |

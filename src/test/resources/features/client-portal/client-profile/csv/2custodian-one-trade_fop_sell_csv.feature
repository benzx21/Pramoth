...
Feature: Client portal
  ...
  Scenario Outline:  CSV - Multi custodian FOP SELL v1...v4 in Trades,  Securities Positions screens (Client Profile)
   ...
   #############################################################v3#################################################################
    ...
    Examples:
      ...
      | client-defaultEnv | JohnDoeCPfopClient | custx11*   | JohnDoeCPfopClient2 | custx11*    | admin-defaultEnv | JohnDoe  | Password11* | T-2       | T        | FOP        | Client Securities Fop | CP:CLIENT:SFL-EUR-BEL:FOP:SELL:2Custodian | EUR     | SELL      | SFL             | CP_CLIENT_FOP_Auto | CP_Auto_Testing_Client_FOP | SFL        | BE0000352618 | FIXED_INCOME | BEGV 10/22/31       | EUR         | USA         | ACLRAU2S              | BAGHGHAC              | CITI        | CITIDepotCode | BNY         | BNYDepotCode | 1000          | -1,000 | -2,000   | 173.0000  | 0.5000     | -346,000.00    | -173,000.00               | -86,500.00           |

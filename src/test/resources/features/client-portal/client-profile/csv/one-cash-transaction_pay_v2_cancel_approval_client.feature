...
Feature: Client portal
  ...
  Scenario Outline: CSV - Validate single cash PAY trough v1...v2 in Cash Transactions, Cash Positions and Ledger Postings screens as Client
   ...
   #to check below
    ...
    Examples:
      ...
      | client-defaultEnv | JohnDoeCPCTClient | custx11*   | JohnDoeCPCTClient2 | custx11*    | admin-defaultEnv | JohnDoe  | Password11* | T         | Client Cash  | CP:Csv:SFL-GBP-BEL:PAY:CANCv2:T | GBP     | PAY       | SFL             | CP_CLIENT_CT_CC_Auto | CP_Auto_Testing_CT_Client | BNY        | BNYNostroCode | AUD | 1000   | -1,000.00 | 0.4100 | -860.00  | -410.00      | -1,000.00 | -860.00       | -410.00           | 0.00    | 0.00          | 0.00              | Free Cash 'In Transit' Account | Custody Client Cash Account |

...
Feature: Client portal
  ...
  Scenario Outline: CSV - Validate single cash PAY trough v1...v4 in Cash Transactions, Cash Positions and Ledger Postings screens as Client
    ...
    Examples:
      ...
      | client-defaultEnv | JohnDoeCPCTClient | custx11*   | JohnDoeCPCTClient2 | custx11*    | admin-defaultEnv | JohnDoe  | Password11* | T         | Client Cash  | CP:Csv:SFL-GBP-BEL:PAY:CANCv4:T | GBP     | PAY       | SFL             | CP_CLIENT_CT_CC_Auto | CP_Auto_Testing_CT_Client | BNY        | BNYNostroCode | EUR | 1000   | -1,000.00 | 1.9200 | -1,920.00 | -1,920.00    | -1,000.00 | -1,920.00     | -1,920.00         | 0.00    | 0.00          | 0.00              | Free Cash 'In Transit' Account | Custody Client Cash Account | Nostro Account   | Free Cash 'In Transit' Account |

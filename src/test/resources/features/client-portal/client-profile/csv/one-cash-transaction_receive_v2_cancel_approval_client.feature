...
Feature: Client portal
  ...
  Scenario Outline: CSV - Validate single cash trough RECEIVE v1...v2 cancel in Cash Transactions, Cash Positions and Ledger Postings screens as Client
    ...
    Examples:
      ...
      | client-defaultEnv | JohnDoeCPCTClient | custx11*   | JohnDoeCPCTClient2 | custx11*    | admin-defaultEnv | JohnDoe  | Password11* | T         | Client Cash  | CP:Csv:SFL-GBP-BEL:REC:CANCv2:T | GBP     | RECEIVE   | SFL             | CP_CLIENT_CT_CC_Auto | CP_Auto_Testing_CT_Client | BNY        | BNYNostroCode | AUD | 1000   | 1,000.00 | 0.4100 | 860.00   | 410.00       | 0.00    | 0.00          | 0.00              | 1,000.00 | 860.00        | 410.00            | Custody Client Cash Account | Free Cash 'In Transit' Account |

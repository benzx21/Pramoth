...
Feature: Client portal
  ...
  Scenario Outline: CSV - Single trade FOP sell v1...v4 in Trades, Ledger Postings and Securities Positions screens via Client profile
    ...
    Examples:
      ...
      | client-defaultEnv | JohnDoeCPfopClient | custx11*   | JohnDoeCPfopClient2 | custx11*    | admin-defaultEnv | JohnDoe  | Password11* | T-2       | T        | FOP        | Client Securities Fop | CP:CLIENT:SFL-EUR-BEL:FOP:T-2:SELL:FI | EUR     | SELL      | SFL             | CP_CLIENT_FOP_Auto | CP_Auto_Testing_Client_FOP | SFL        | BE0000352618 | FIXED_INCOME | BEGV 10/22/31       | EUR         | GBR         | CITI      | CITIDepotCode | 1000          | -1,000 | 173.0000  | 0.5000     | -173,000.00 | -86,500.00           | Market Securities 'In Transit' Account | Custody Client Securities Account | Depot Account   | Market Securities 'In Transit' Account |

...
Feature: Client portal
  ...
  Scenario Outline: CSV - Single trade FOP buy v1...v4 in Trades, Ledger Postings and Securities Positions screens via Client profile
    ...
    Then "TRADE" CSV is uploaded successfully
      ...
      | TRADE     | UK                    | NEW          | APKEFIHH              | VenueID01 | Testexid01 | APKEFIHH            | 5.26             | CPTYName01            | CPTYLocal02                   | CPTYLocalCustAccNumber02                | 123                       | CPTY             | CPTY1234568      | InterBank02      | Place02                | REG02        | csv upload client portal | Stamp02         | 1                   | TRUE             | 10                     | Intermediaries | FALSE                      | <legalEntityCode> | <clientCode> | <clientMasterAccountName> | <brokerCode> | @date(<tradeDate>) | <isin> | <securityType> | <securityDescription> | <subAccount>     | <direction> | <tradeQuantity> | <settMethod>      | @date(<settDate>) | <settCountry>     | @default() | @default()        |
    ...
    Examples:
      ...
      | client-defaultEnv | JohnDoeCPfopClient | custx11*   | JohnDoeCPfopClient2 | custx11*    | admin-defaultEnv | JohnDoe  | Password11* | T-2       | T        | FOP        | Client Securities Fop | CP:CLIENT:SFL-EUR-BEL:FOP:T-2:BUY:EQ | EUR     | BUY       | SFL             | CP_CLIENT_FOP_Auto | CP_Auto_Testing_Client_FOP | SFL        | NL0000235190 | EQUITY       | AIRBUS              | EUR         | JPN         | CITI      | CITIDepotCode | 1000          | 1,000 | 0.7713    | 0.5000     | 771.30    | 385.65               | Custody Client Securities Account | Market Securities 'In Transit' Account | Market Securities 'In Transit' Account | Depot Account   |

...
Feature: Client portal
  ...
  Scenario Outline: Modal - Validate single cash RECEIVE trough v1...v4 in Cash Transactions, Cash Positions and Ledger Postings screens via client profile
    ...
    Examples:
      ...
      | client-defaultEnv | JohnDoeCPCTClient | custx11*   | JohnDoeCPCTClient2 | custx11*    | admin-defaultEnv | JohnDoe  | Password11* | T         | Client Cash  | CP:Mod:SFL-GBP-BEL:REC:CANCv4:T | GBP     | RECEIVE   | SFL             | CP_CLIENT_CT_CC_Auto | CP_Auto_Testing_CT_Client | CITI       | CITINostroCode | GBP | 1000             | T        | 1,000.00 | 1.0000 | 820.00   | 1,000.00     | 0.00    | 0.00          | 0.00              | 1,000.00 | 820.00        | 1,000.00          | Custody Client Cash Account | Free Cash 'In Transit' Account | Free Cash 'In Transit' Account | Nostro Account   |

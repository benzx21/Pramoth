...
Feature: Client portal
  ...
  Scenario Outline: CSV - Validate single cash RECEIVE trough v1...v4 in Cash Transactions, Cash Positions and Ledger Postings screens (Super Client)
    ...
    Examples:
      ...
      | client-defaultEnv | JohnDoeCPCTSuper | custx11*   | admin-defaultEnv | JohnDoe  | Password11* | T         | Client Cash  | CP:Csv:SFL-EUR-GBR:REC:CANCv4:T | EUR     | RECEIVE   | SFL             | CP_CT_CC_Auto | CP_Auto_Testing_CT_SuperClient | BNY        | BNYNostroCode | CHF | 1000   | 1,000.00 | 3.6200 | 3,620.00 | 3,620.00     | 0.00    | 0.00          | 0.00              | 1,000.00 | 3,620.00      | 3,620.00          | Custody Client Cash Account | Free Cash 'In Transit' Account | Free Cash 'In Transit' Account | Nostro Account   |

...
Feature: Client portal
  ...
  Scenario Outline: Modal - Single trade FOP v1...v4 in Trades, Ledger Postings and Securities Positions screens (Super Client)
    ...
    When click "Trade Activity" "tab"
    And filter on "Trades" by
      | Name        | Operator | Value        |
    ...
    Examples:
      ...
      | c-env             | c-username   | c-password | env              | username | password    | tradeDate | settDate | settMethod | tradeSubType          | subAccount                        | baseCcy | direction | clientCode  | clientMasterAccountName | isin         | securityType | securityDescription | securityCcy | settCountry | depotBank | depotCode    | tradeQuantity | qty   | secPriceT | secFxRateT | qty*price  | qty*price*secFxRateT | cre_sec_unSett_gl                 | deb_sec_unSett_gl                      | cre_sec_sett_gl                        | deb_sec_sett_gl |
      | client-defaultEnv | JohnDoeCPfop | custx11*   | admin-defaultEnv | JohnDoe  | Password11* | T-2       | T        | FOP        | Client Securities Fop | CP:Mod:SFL-AUD-BEL:FOP:T-2:BUY:FI | AUD     | BUY       | CP_FOP_Auto | CP_Auto_Testing_FOP     | BE0000352618 | FIXED_INCOME | BEGV 10/22/31       | EUR         | USA         | BNY       | BNYDepotCode | 1000          | 1,000 | 173.0000  | 1.7200     | 173,000.00 | 297,560.00           | Custody Client Securities Account | Market Securities 'In Transit' Account | Market Securities 'In Transit' Account | Depot Account   |
      | client-defaultEnv | JohnDoeCPfop | custx11*   | admin-defaultEnv | JohnDoe  | Password11* | T-1       | T        | FOP        | Client Securities Fop | CP:Mod:SFL-AUD-GBR:FOP:T-1:BUY:FI | AUD     | BUY       | CP_FOP_Auto | CP_Auto_Testing_FOP     | BE0000352618 | FIXED_INCOME | BEGV 10/22/31       | EUR         | JPN         | BNY       | BNYDepotCode | 1000          | 1,000 | 173.0000  | 1.7200     | 173,000.00 | 297,560.00           | Custody Client Securities Account | Market Securities 'In Transit' Account | Market Securities 'In Transit' Account | Depot Account   |
      | client-defaultEnv | JohnDoeCPfop | custx11*   | admin-defaultEnv | JohnDoe  | Password11* | T         | T        | FOP        | Client Securities Fop | CP:Mod:SFL-AUD-AUS:FOP:T:BUY:FI   | AUD     | BUY       | CP_FOP_Auto | CP_Auto_Testing_FOP     | BE0000352618 | FIXED_INCOME | BEGV 10/22/31       | EUR         | GBR         | BNY       | BNYDepotCode | 1000          | 1,000 | 173.0000  | 1.7200     | 173,000.00 | 297,560.00           | Custody Client Securities Account | Market Securities 'In Transit' Account | Market Securities 'In Transit' Account | Depot Account   |
      | client-defaultEnv | JohnDoeCPfop | custx11*   | admin-defaultEnv | JohnDoe  | Password11* | T-2       | T        | FOP        | Client Securities Fop | CP:Mod:SFL-AUD-BEL:FOP:T-2:BUY:EQ | AUD     | BUY       | CP_FOP_Auto | CP_Auto_Testing_FOP     | NL0000235190 | EQUITY       | AIRBUS              | EUR         | USA         | BNY       | BNYDepotCode | 1000          | 1,000 | 0.7713    | 1.7200     | 771.30     | 1,326.64             | Custody Client Securities Account | Market Securities 'In Transit' Account | Market Securities 'In Transit' Account | Depot Account   |
      | client-defaultEnv | JohnDoeCPfop | custx11*   | admin-defaultEnv | JohnDoe  | Password11* | T-1       | T        | FOP        | Client Securities Fop | CP:Mod:SFL-AUD-FRA:FOP:T-1:BUY:EQ | AUD     | BUY       | CP_FOP_Auto | CP_Auto_Testing_FOP     | NL0000235190 | EQUITY       | AIRBUS              | EUR         | FRA         | BNY       | BNYDepotCode | 1000          | 1,000 | 0.7713    | 1.7200     | 771.30     | 1,326.64             | Custody Client Securities Account | Market Securities 'In Transit' Account | Market Securities 'In Transit' Account | Depot Account   |
      | client-defaultEnv | JohnDoeCPfop | custx11*   | admin-defaultEnv | JohnDoe  | Password11* | T         | T        | FOP        | Client Securities Fop | CP:Mod:SFL-AUD-BEL:FOP:T:BUY:EQ   | AUD     | BUY       | CP_FOP_Auto | CP_Auto_Testing_FOP     | NL0000235190 | EQUITY       | AIRBUS              | EUR         | USA         | BNY       | BNYDepotCode | 1000          | 1,000 | 0.7713    | 1.7200     | 771.30     | 1,326.64             | Custody Client Securities Account | Market Securities 'In Transit' Account | Market Securities 'In Transit' Account | Depot Account   |
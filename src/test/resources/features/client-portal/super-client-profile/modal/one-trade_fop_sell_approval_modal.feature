...
Feature: Client portal
  ...
  Scenario Outline: Modal - Single trade FOP v1...v4 in Trades, Ledger Postings and Securities Positions screens (Super Client)
    ...
    Examples:
      ...
      | client-defaultEnv | JohnDoeCPfop | custx11*   | admin-defaultEnv | JohnDoe  | Password11* | T-2       | T        | FOP        | Client Securities Fop | CP:Mod:SFL-AUD-BEL:FOP:T-2:SELL:EQ | AUD     | SELL      | CP_FOP_Auto | CP_Auto_Testing_FOP     | NL0000235190 | EQUITY       | AIRBUS              | EUR         | GBR         | CITI      | CITIDepotCode | 1000          | -1,000 | 0.7713    | 1.7200     | -771.30     | -1,326.64            | Market Securities 'In Transit' Account | Custody Client Securities Account | Depot Account   | Market Securities 'In Transit' Account |
      | client-defaultEnv | JohnDoeCPfop | custx11*   | admin-defaultEnv | JohnDoe  | Password11* | T-1       | T        | FOP        | Client Securities Fop | CP:Mod:SFL-AUD-BEL:FOP:T-1:SELL:EQ | AUD     | SELL      | CP_FOP_Auto | CP_Auto_Testing_FOP     | NL0000235190 | EQUITY       | AIRBUS              | EUR         | JPN         | CITI      | CITIDepotCode | 1000          | -1,000 | 0.7713    | 1.7200     | -771.30     | -1,326.64            | Market Securities 'In Transit' Account | Custody Client Securities Account | Depot Account   | Market Securities 'In Transit' Account |
      | client-defaultEnv | JohnDoeCPfop | custx11*   | admin-defaultEnv | JohnDoe  | Password11* | T         | T        | FOP        | Client Securities Fop | CP:Mod:SFL-AUD-FRA:FOP:T:SELL:EQ   | AUD     | SELL      | CP_FOP_Auto | CP_Auto_Testing_FOP     | NL0000235190 | EQUITY       | AIRBUS              | EUR         | USA         | CITI      | CITIDepotCode | 1000          | -1,000 | 0.7713    | 1.7200     | -771.30     | -1,326.64            | Market Securities 'In Transit' Account | Custody Client Securities Account | Depot Account   | Market Securities 'In Transit' Account |
      | client-defaultEnv | JohnDoeCPfop | custx11*   | admin-defaultEnv | JohnDoe  | Password11* | T-2       | T        | FOP        | Client Securities Fop | CP:Mod:SFL-AUD-BEL:FOP:T-2:SELL:FI | AUD     | SELL      | CP_FOP_Auto | CP_Auto_Testing_FOP     | BE0000352618 | FIXED_INCOME | BEGV 10/22/31       | EUR         | GBR         | CITI      | CITIDepotCode | 1000          | -1,000 | 173.0000  | 1.7200     | -173,000.00 | -297,560.00          | Market Securities 'In Transit' Account | Custody Client Securities Account | Depot Account   | Market Securities 'In Transit' Account |
      | client-defaultEnv | JohnDoeCPfop | custx11*   | admin-defaultEnv | JohnDoe  | Password11* | T-1       | T        | FOP        | Client Securities Fop | CP:Mod:SFL-AUD-AUS:FOP:T-1:SELL:FI | AUD     | SELL      | CP_FOP_Auto | CP_Auto_Testing_FOP     | BE0000352618 | FIXED_INCOME | BEGV 10/22/31       | EUR         | USA         | CITI      | CITIDepotCode | 1000          | -1,000 | 173.0000  | 1.7200     | -173,000.00 | -297,560.00          | Market Securities 'In Transit' Account | Custody Client Securities Account | Depot Account   | Market Securities 'In Transit' Account |
      | client-defaultEnv | JohnDoeCPfop | custx11*   | admin-defaultEnv | JohnDoe  | Password11* | T         | T        | FOP        | Client Securities Fop | CP:Mod:SFL-AUD-GBR:FOP:T:SELL:FI   | AUD     | SELL      | CP_FOP_Auto | CP_Auto_Testing_FOP     | BE0000352618 | FIXED_INCOME | BEGV 10/22/31       | EUR         | JPN         | CITI      | CITIDepotCode | 1000          | -1,000 | 173.0000  | 1.7200     | -173,000.00 | -297,560.00          | Market Securities 'In Transit' Account | Custody Client Securities Account | Depot Account   | Market Securities 'In Transit' Account |

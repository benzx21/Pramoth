  ...
  Scenario Outline: Modal - Single trade FOP v1...v4 in Trades, Ledger Postings and Securities Positions screens (Super Client)
   ...
   #############################################################v3#################################################################
    ...
    Examples:
      ...
      | client-defaultEnv | JohnDoeCPfop | custx11*   | admin-defaultEnv | JohnDoe  | Password11* | T-2       | T        | FOP        | Client Securities Fop | CP:SFL-AUD-BEL:FOP:2Custodian | AUD     | SELL      | SFL             | CP_FOP_Auto | CP_Auto_Testing_FOP     | SFL        | BE0000352618 | FIXED_INCOME | BEGV 10/22/31       | EUR         | USA         | ACLRAU2S              | BAGHGHAC              | CITI        | CITIDepotCode | BNY         | BNYDepotCode | 1000          | -1,000 | -2,000   | 173.0000  | 1.7200     | -346,000.00    | -595,120.00               | -297,560.00          |

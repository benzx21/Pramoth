...
Feature: Client portal
  ...
  Scenario Outline: Modal - Validate single cash PAY trough v1...v4 in Cash Transactions, Cash Positions and Ledger Postings screens via Super client profile
    ...
    Examples:
      ...
      | client-defaultEnv | JohnDoeCPCTSuper | custx11*   | admin-defaultEnv | JohnDoe  | Password11* | T         | Client Cash  | CP:Mod:SFL-EUR-BEL:PAY:CANCv4:T | EUR     | PAY       | SFL             | CP_CT_CC_Auto | CP_Auto_Testing_CT_SuperClient | CITI       | CITINostroCode | JPY | 1000             | T        | -1,000.00 | 1.3600 | -1,720.00 | -1,360.00    | -1,000.00 | -1,720.00     | -1,360.00         | 0.00    | 0.00          | 0.00              | Free Cash 'In Transit' Account | Custody Client Cash Account | Nostro Account   | Free Cash 'In Transit' Account |

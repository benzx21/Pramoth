...
Feature: Admin portal
  ...
  Scenario Outline: MT547 Validate Swift settle of DVP SELL trough v1...v4 in Trades, Securities Positions, Cash Positions and Ledger Postings screens
...
-}
  """
    ...
    Examples:
      ...
      | admin-defaultEnv | JohnDoe  | Password11* | T-2       | T        | DVP        | Client Market Trade | AP:csv:SFL-GBP-BEL:DVP:T-2:SELL:FI | GBP     | SELL      | RECEIVE        | SFL             | Auto_Swift_Full_Settle | Auto_Swift_Settle_Full  | SFL        | BE0000352618 | FIXED_INCOME | BEGV 10/22/31       | EUR         | JPY     | BNY        | BNYNostroCode | JPN         | BNY       | BNYDepotCode | 1000          | 10         | JPY | 10000  | 10001            | -1,000 | 10.0000 | 10,000.00 | 10,001.00 | 1.7400 | 17,401.74    | 4,200.42         | 173.0000  | 1.9200     | 17,201.72     | 4,100.41          | 0.00        | 0.00              | 0.00                  | 10,001.00   | 17,201.72         | 4,100.41              | -173,000.00 | -332,160.00          | Custody Client Cash Account | Market Cash 'In Transit' Account | Market Securities 'In Transit' Account | Custody Client Securities Account | Market Cash 'In Transit' Account | Nostro Account   | Depot Account   | Market Securities 'In Transit' Account |

...
Feature: Admin portal
  ...
  Scenario Outline: MT546 Validate single trade FOP trough v1...v4 in Trades, Securities Positions and Ledger Postings screens
    ...
    Examples:
      ...
      | admin-defaultEnv | JohnDoe  | Password11* | T-2       | T        | FOP        | Client Securities Fop | AP:csv:SFL-GBP-BEL:FOP:T-2:SELL:EQ | GBP     | SELL      | SFL             | Auto_Swift_Full_Settle | Auto_Swift_Settle_Full  | SFL        | NL0000235190 | EQUITY       | AIRBUS              | EUR         | GBR         | BNY       | BNYDepotCode | 1000          | -1,000 | 0.7713    | 1.9200     | -771.30   | -1,480.90            | Market Securities 'In Transit' Account | Custody Client Securities Account | Depot Account   | Market Securities 'In Transit' Account |

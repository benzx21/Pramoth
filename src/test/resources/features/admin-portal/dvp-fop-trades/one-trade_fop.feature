...
Feature: Admin portal
  ...
  Scenario Outline: Validate single trade FOP trough v1...v4 in Trades, Securities Positions and Ledger Postings screens
    ...
    Examples:
      ...
      | admin-defaultEnv | JohnDoe  | Password11* | T-2       | T        | FOP        | Client Securities Fop | JPM:SFL-USD-AUS:FOP:T-2:BUY:FI  | AUD     | BUY       | SFL             | JPM        | JPM                     | SFL        | BE0000352618 | FIXED_INCOME | BEGV 10/22/31       | EUR         | USA         | CITI      | CITIDepotCode | 1000          | 1,000  | 173.0000  | 1.7200     | 173,000.00  | 297,560.00           | Custody Client Securities Account      | Market Securities 'In Transit' Account | Market Securities 'In Transit' Account | Depot Account                          |
      | admin-defaultEnv | JohnDoe  | Password11* | T-2       | T        | FOP        | Client Securities Fop | JPM:SFL-AUD-GBR:FOP:T-2:SELL:FI | AUD     | SELL      | SFL             | JPM        | JPM                     | SFL        | BE0000352618 | FIXED_INCOME | BEGV 10/22/31       | EUR         | AUS         | CITI      | CITIDepotCode | 1000          | -1,000 | 173.0000  | 1.7200     | -173,000.00 | -297,560.00          | Market Securities 'In Transit' Account | Custody Client Securities Account      | Depot Account                          | Market Securities 'In Transit' Account |
      | admin-defaultEnv | JohnDoe  | Password11* | T-2       | T        | FOP        | Client Securities Fop | JPM:SFL-EUR-FRA:FOP:T-2:BUY:EQ  | AUD     | BUY       | SFL             | JPM        | JPM                     | SFL        | NL0000235190 | EQUITY       | AIRBUS              | EUR         | USA         | CITI      | CITIDepotCode | 1000          | 1,000  | 0.7713    | 1.7200     | 771.30      | 1,326.64             | Custody Client Securities Account      | Market Securities 'In Transit' Account | Market Securities 'In Transit' Account | Depot Account                          |
      | admin-defaultEnv | JohnDoe  | Password11* | T-2       | T        | FOP        | Client Securities Fop | JPM:SFL-AUD-BEL:FOP:T-2:SELL:EQ | AUD     | SELL      | SFL             | JPM        | JPM                     | SFL        | NL0000235190 | EQUITY       | AIRBUS              | EUR         | GBR         | CITI      | CITIDepotCode | 1000          | -1,000 | 0.7713    | 1.7200     | -771.30     | -1,326.64            | Market Securities 'In Transit' Account | Custody Client Securities Account      | Depot Account                          | Market Securities 'In Transit' Account |
      | admin-defaultEnv | JohnDoe  | Password11* | T-1       | T        | FOP        | Client Securities Fop | JPM:SFL-USD-GBR:FOP:T-1:BUY:FI  | AUD     | BUY       | SFL             | JPM        | JPM                     | SFL        | BE0000352618 | FIXED_INCOME | BEGV 10/22/31       | EUR         | FRA         | CITI      | CITIDepotCode | 1000          | 1,000  | 173.0000  | 1.7200     | 173,000.00  | 297,560.00           | Custody Client Securities Account      | Market Securities 'In Transit' Account | Market Securities 'In Transit' Account | Depot Account                          |
      | admin-defaultEnv | JohnDoe  | Password11* | T-1       | T        | FOP        | Client Securities Fop | JPM:SFL-GBP-AUS:FOP:T-1:SELL:FI | AUD     | SELL      | SFL             | JPM        | JPM                     | SFL        | BE0000352618 | FIXED_INCOME | BEGV 10/22/31       | EUR         | JPN         | CITI      | CITIDepotCode | 1000          | -1,000 | 173.0000  | 1.7200     | -173,000.00 | -297,560.00          | Market Securities 'In Transit' Account | Custody Client Securities Account      | Depot Account                          | Market Securities 'In Transit' Account |
      | admin-defaultEnv | JohnDoe  | Password11* | T-1       | T        | FOP        | Client Securities Fop | JPM:SFL-USD-FRA:FOP:T-1:BUY:EQ  | AUD     | BUY       | SFL             | JPM        | JPM                     | SFL        | NL0000235190 | EQUITY       | AIRBUS              | EUR         | USA         | CITI      | CITIDepotCode | 1000          | 1,000  | 0.7713    | 1.7200     | 771.30      | 1,326.64             | Custody Client Securities Account      | Market Securities 'In Transit' Account | Market Securities 'In Transit' Account | Depot Account                          |
      | admin-defaultEnv | JohnDoe  | Password11* | T-1       | T        | FOP        | Client Securities Fop | JPM:SFL-ILS-BEL:FOP:T-1:SELL:EQ | AUD     | SELL      | SFL             | JPM        | JPM                     | SFL        | NL0000235190 | EQUITY       | AIRBUS              | EUR         | GBR         | CITI      | CITIDepotCode | 1000          | -1,000 | 0.7713    | 1.7200     | -771.30     | -1,326.64            | Market Securities 'In Transit' Account | Custody Client Securities Account      | Depot Account                          | Market Securities 'In Transit' Account |
      | admin-defaultEnv | JohnDoe  | Password11* | T         | T        | FOP        | Client Securities Fop | JPM:SFL-CZK-AUS:FOP:T:BUY:FI    | AUD     | BUY       | SFL             | JPM        | JPM                     | SFL        | BE0000352618 | FIXED_INCOME | BEGV 10/22/31       | EUR         | FRA         | CITI      | CITIDepotCode | 1000          | 1,000  | 173.0000  | 1.7200     | 173,000.00  | 297,560.00           | Custody Client Securities Account      | Market Securities 'In Transit' Account | Market Securities 'In Transit' Account | Depot Account                          |
      | admin-defaultEnv | JohnDoe  | Password11* | T         | T        | FOP        | Client Securities Fop | JPM:SFL-JPY-GBR:FOP:T:SELL:FI   | AUD     | SELL      | SFL             | JPM        | JPM                     | SFL        | BE0000352618 | FIXED_INCOME | BEGV 10/22/31       | EUR         | ISR         | CITI      | CITIDepotCode | 1000          | -1,000 | 173.0000  | 1.7200     | -173,000.00 | -297,560.00          | Market Securities 'In Transit' Account | Custody Client Securities Account      | Depot Account                          | Market Securities 'In Transit' Account |
      | admin-defaultEnv | JohnDoe  | Password11* | T         | T        | FOP        | Client Securities Fop | JPM:SFL-SGD-BEL:FOP:T:BUY:EQ    | AUD     | BUY       | SFL             | JPM        | JPM                     | SFL        | NL0000235190 | EQUITY       | AIRBUS              | EUR         | USA         | CITI      | CITIDepotCode | 1000          | 1,000  | 0.7713    | 1.7200     | 771.30      | 1,326.64             | Custody Client Securities Account      | Market Securities 'In Transit' Account | Market Securities 'In Transit' Account | Depot Account                          |
      | admin-defaultEnv | JohnDoe  | Password11* | T         | T        | FOP        | Client Securities Fop | JPM:SFL-JPY-FRA:FOP:T:SELL:EQ   | AUD     | SELL      | SFL             | JPM        | JPM                     | SFL        | NL0000235190 | EQUITY       | AIRBUS              | EUR         | GBR         | CITI      | CITIDepotCode | 1000          | -1,000 | 0.7713    | 1.7200     | -771.30     | -1,326.64            | Market Securities 'In Transit' Account | Custody Client Securities Account      | Depot Account                          | Market Securities 'In Transit' Account |
